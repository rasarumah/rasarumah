...
export default function Home() {
  ...
  const menuItems = [
    { id: 1, name: "Rendang Sapi Premium", price: "Rp 45.000", image: "/menu1.png", desc: "Rendang sapi empuk dengan bumbu rempah tradisional yang meresap sempurna" },
    { id: 2, name: "Ayam Ungkep Gurih", price: "Rp 35.000", image: "/menu2.png", desc: "Ayam ungkep dengan bumbu tradisional yang gurih dan lezat" },
    { id: 3, name: "Sambal Cumi Pedas", price: "Rp 40.000", image: "/menu3.png", desc: "Cumi segar dengan sambal pedas yang menggigit lidah" },
    { id: 4, name: "Gulai Kambing Spesial", price: "Rp 50.000", image: "/menu4.png", desc: "Gulai kambing dengan kuah santan kental dan bumbu rempah" },
    { id: 5, name: "Semur Jengkol Tradisional", price: "Rp 30.000", image: "/menu5.png", desc: "Semur jengkol dengan cita rasa manis gurih khas Betawi" },
    { id: 6, name: "Ikan Balado Pedas", price: "Rp 38.000", image: "/menu6.png", desc: "Ikan segar dengan balado pedas yang menggoda selera" },
  ];
  ...
  const testimonials = [
    {
      name: "Andini, Jakarta",
      text: "Rendangnya empuk banget, bumbu meresap! Jadi stok wajib di kulkas.",
      rating: 5,
      avatar: "👩🏻‍💼"
    },
    {
      name: "Budi, Bandung", 
      text: "Praktis banget buat yang sibuk kerja. Rasanya kayak masakan mama!",
      rating: 5,
      avatar: "👨🏻‍💻"
    },
    {
      name: "Sari, Surabaya",
      text: "Sambal cuminya juara! Anak-anak juga suka. Recommended banget!",
      rating: 5,
      avatar: "👩🏻‍🍳"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white overflow-x-hidden">
      {/* Floating Navigation */}
      <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 bg-white/95 backdrop-blur-lg shadow-xl rounded-full z-50 transition-all duration-500 border border-amber-200">
        <div className="px-8 py-4">
          <div className="flex items-center justify-between gap-8">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <a href="#galeri" className="text-gray-700 hover:text-orange-600 transition-colors font-medium">Galeri</a>
              <a href="#testimoni" className="text-gray-700 hover:text-orange-600 transition-colors font-medium">Testimoni</a>
            </div>
            <a 
              href={createWhatsAppLink("Halo Rasa Rumah! Saya tertarik dengan produk Heat n Eat. Bisa bantu saya untuk pemesanan?")}
              className="bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white px-6 py-3 rounded-full font-bold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
              Pesan Sekarang
            </a>
          </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 pt-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div 
              ...
              id="hero-text"
            >
              <div className="inline-flex items-center bg-white/90 backdrop-blur-sm px-6 py-3 rounded-full text-green-700 font-bold mb-6 shadow-lg animate-pulse">
                <span className="w-3 h-3 bg-green-500 rounded-full mr-3 animate-ping"></span>
                🔥 Brand Terpercaya Heat n Eat
              </div>
              ...
              <h2 className="text-3xl md:text-5xl text-gray-700 mb-6 font-bold leading-tight">
                Masakan Rumahan 
                <span className="block text-red-600 mt-2 animate-bounce">
                  Siap Saji dalam 5 Menit ⚡
                </span>
              </h2>
              
              <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed font-medium">
                Rendang, Ayam Ungkep, Sambal Cumi, dan lainnya.
                <br />
                <span className="font-bold text-green-700 bg-green-100 px-3 py-1 rounded-full inline-block mt-2">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
                <a 
                  ...
                  className="group bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white px-10 py-5 rounded-full font-bold text-xl transition-all duration-500 shadow-2xl hover:shadow-3xl transform hover:scale-110 hover:-translate-y-2 relative overflow-hidden"
                >
                ...
                <a 
                  href="#menu"
                  className="group border-3 border-green-600 text-green-600 hover:bg-green-600 hover:text-white px-10 py-5 rounded-full font-bold text-xl transition-all duration-500 transform hover:scale-110 relative overflow-hidden"
                >
                  <span className="relative z-10 flex items-center justify-center gap-3">
                    📋 Lihat Menu
              ...
              <div className="flex items-center justify-center lg:justify-start gap-8 pt-8">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600 font-medium">Rating Tertinggi</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-black text-green-600">24/7</div>
                  <div className="text-sm text-gray-600 font-medium">Siap Melayani</div>
                </div>
              </div>
            </div>
            ...
            >
              <div className="relative group">
                {/* Floating elements */}
                <div className="absolute -top-6 -left-6 w-24 h-24 bg-yellow-400 rounded-full opacity-80 animate-pulse"></div>
                <div className="absolute -bottom-4 -right-4 w-16 h-16 bg-red-400 rounded-full opacity-70 animate-bounce"></div>
                
                {/* Main image container */}
                <div className="relative bg-white rounded-3xl p-8 shadow-2xl transform group-hover:rotate-3 transition-all duration-700 border-8 border-gradient-to-r from-orange-200 to-red-200">
                  <div className="relative w-96 h-96 rounded-2xl overflow-hidden shadow-xl">
                    <Image 
                      src="/menu1.png" 
                  ...
                  {/* Floating badges */}
                  <div className="absolute -top-4 -right-4 bg-red-500 text-white px-6 py-3 rounded-full font-bold shadow-lg animate-bounce transform rotate-12">
                    🔥 Best Seller
                  </div>
                  <div className="absolute -bottom-6 -left-6 bg-green-500 text-white px-6 py-3 rounded-full font-bold shadow-lg animate-pulse">
                    ✅ Tanpa Pengawet
                  </div>
                </div>
              </div>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <div className="w-8 h-14 border-3 border-gray-400 rounded-full flex justify-center p-2">
            <div className="w-2 h-6 bg-gradient-to-b from-orange-500 to-red-500 rounded-full animate-pulse"></div>
          </div>
          <div className="text-center mt-2 text-gray-600 font-medium">Scroll</div>
        </div>
      </section>
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: "✅", title: "100% Masakan Asli Rumahan", desc: "Dibuat dengan resep turun temurun keluarga", color: "from-green-400 to-green-600" },
              { icon: "⚡", title: "Siap Saji Dalam 5 Menit", desc: "Panaskan sebentar, langsung nikmat", color: "from-yellow-400 to-orange-500" },
              { icon: "❄️", title: "Tahan Lama di Kulkas", desc: "Bisa disimpan hingga 1 minggu", color: "from-blue-400 to-cyan-500" },
              { icon: "🌿", title: "100% Tanpa Pengawet", desc: "Alami dan sehat untuk keluarga", color: "from-green-500 to-emerald-600" }
            ].map((item, index) => (
              <div 
                key={index}
              ...
              >
                ...
                <div className={`relative bg-white p-8 rounded-2xl shadow-xl text-center transform group-hover:scale-105 group-hover:-translate-y-4 transition-all duration-500 border-2 border-transparent group-hover:border-gradient-to-r ${item.color}`}>
                  <div className="text-6xl mb-6 animate-bounce">{item.icon}</div>
              ...
              >
                ...
                <div className="relative bg-white rounded-3xl shadow-xl overflow-hidden transform group-hover:scale-105 group-hover:-translate-y-6 transition-all duration-700 border-4 border-transparent group-hover:border-white">
                  <div className="relative h-80 overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4 bg-red-500 text-white px-4 py-2 rounded-full font-bold text-sm shadow-lg transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                      🔥 Hot
                    </div>
                  </div>
                  <div className="p-8">
                    <h3 className="text-2xl font-bold text-gray-800 mb-3 group-hover:text-red-600 transition-colors duration-300">{item.name}</h3>
                    <p className="text-gray-600 mb-4 leading-relaxed">{item.desc}</p>
                    <div className="text-3xl font-black text-red-600 mb-6">{item.price}</div>
                    <div className="flex gap-3">
                      <a
                        href={createWhatsAppLink(`Halo! Saya ingin pesan ${item.name} seharga ${item.price}. Bisa dibantu untuk pemesanan?`)}
                        className="flex-1 bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white text-center py-4 px-6 rounded-xl font-bold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                      >
                        🛒 Pesan
                      </a>
                      <a
                        href={createWhatsAppLink(`Halo! Saya ingin tahu lebih detail tentang ${item.name}. Bisa dijelaskan?`)}
                        className="flex-1 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white text-center py-4 px-6 rounded-xl font-bold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                      >
                        📋 Detail
                      </a>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {galleryImages.map((image, index) => (
              ...
              >
                ...
                <div className="relative h-80 md:h-96 rounded-2xl overflow-hidden shadow-2xl transform group-hover:scale-105 group-hover:-rotate-2 transition-all duration-700">
                  <Image
                    src={image}
                    alt={`Galeri ${index + 1}`}
                    fill
                  ...
                  <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <h3 className="text-xl font-bold mb-2">Galeri {index + 1}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div className="relative bg-white p-8 rounded-3xl shadow-xl transform group-hover:scale-105 group-hover:-translate-y-4 transition-all duration-500 border-l-4 border-green-500">
                  ...
                  <div className="text-6xl text-green-500 mb-4 opacity-20">&ldquo;</div>
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { step: "1", title: "Pilih Produk", desc: "Pilih menu favorit dari katalog kami", icon: "🛍️", color: "from-blue-400 to-purple-500" },
              { step: "2", title: "Klik Pesan", desc: "Klik tombol 'Pesan Sekarang' via WhatsApp", icon: "📱", color: "from-green-400 to-green-600" },
              { step: "3", title: "Transfer", desc: "Transfer dan kirim bukti pembayaran", icon: "💳", color: "from-yellow-400 to-orange-500" },
              { step: "4", title: "Selesai", desc: "Pesanan diproses dan dikirim ke alamat", icon: "🚚", color: "from-red-400 to-pink-500" }
            ].map((item, index) => (
              <div 
                key={index}
              ...
              >
                <div className="relative">
                  <div className={`bg-gradient-to-r ${item.color} w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl transform group-hover:scale-125 group-hover:rotate-12 transition-all duration-500`}>
                    <span className="text-3xl font-bold text-white">{item.step}</span>
                  </div>
                  <div className="text-5xl mb-4 animate-bounce" style={{animationDelay: `${index * 0.5}s`}}>{item.icon}</div>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4 group-hover:text-blue-600 transition-colors duration-300">{item.title}</h3>
                  <p className="text-gray-600 leading-relaxed">{item.desc}</p>
                </div>
                {index < 3 && (
                  <div className="hidden md:block absolute top-10 -right-8 text-3xl text-gray-400 animate-pulse">
                    →
                  </div>
                )}
              </div>
